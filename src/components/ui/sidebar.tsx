  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-[calc(100svh-8px)] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex ",
          side === "left"
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 ml-5.5 mr-3 mb-3.5", className)}
      {...props}
    />
  )
}
